...
# AgentFrame vendoring: this file lives inside the skill, not at the upstream repo root,
# so --all resolves the shipped assets one level up instead of via skills/diagram-design/.
