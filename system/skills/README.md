...
| [`docx/`](docx/) | Generic `.docx` creation and editing; validate exports through `system/tools/docx_validate.py` | The requested output or source is a Word document | Vendored (see [`docx/VENDOR.md`](docx/VENDOR.md)) |
