...
| [`preview-server.md`](preview-server.md) | Local surface start-or-open, preview deep links, noise hygiene | A turn writes a previewable file (markdown, HTML, image, PDF, video, PPTX/DOCX) under `workspace/projects/*/`, or the operator asks for the dashboard/preview |
