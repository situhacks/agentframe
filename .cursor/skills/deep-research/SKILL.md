---
name: deep-research
description: Use for a substantial, sourced research question that needs multiple sections, source comparison, and synthesis using native web/file tools and optional subagents. Do not use for a quick lookup or a single-page summary.
---
