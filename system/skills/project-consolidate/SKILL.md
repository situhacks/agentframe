...
2. Measure the project: line counts for `knowledge/raid-log.md`, `knowledge/decision-log.md`, `knowledge/workback-schedule.md`, `activity.md`, and `project.md`; resolved-vs-open ratios (a log >70% resolved rows recommends archiving); tracker rows delivered >30 days ago; compiled-truth headers older than their latest timeline entry.
