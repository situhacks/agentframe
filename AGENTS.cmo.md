...
| Publish coordination | [post-final template](library/domains/marketing/deliverables/post-final/template.md), the post's `post-FINAL.md` named by the campaign tracker, `activity.md` | [voice mini-retro](library/process/voice-mini-retro.md) if delivered copy materially differs | Separate `published.md` files |
...
When the operator provides a published post link, follow the Publish / Export Mechanics procedure in [`library/domains/marketing/deliverables/post-final/template.md`](library/domains/marketing/deliverables/post-final/template.md).
