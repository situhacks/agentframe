...
| [`deck-production.md`](deck-production.md) | Central Deck/PPTX route, PPT Master default, and follow-up-pass versioning/round-trip rules | A deliverable needs deck-shaped output, or a shared deck gets a revision pass |
