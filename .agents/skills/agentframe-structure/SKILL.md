...
description: |
  Use for structural AgentFrame system work: adding, renaming, defaulting, or retiring project flows or deliverable types; creating process files; changing phase systems; or moving workflow ownership between flows, processes, templates, skills, and task routers. Do not use for ordinary one-file patches or project deliverable work.
allowed-tools:
  - Read
  - Write
  - Edit
